...
\paragraph{Macroeconomic and Socio-demographic Factors}
The USA spans 9 984 670 square kilometers and five time zones\footnote{Considering no overseas terrorities.}. This makes the country the third largest in the world by area. (\cite{CentralIntelligenceAgency.20160719})
...
\bildcite{US_Import_ICT_Services}{U.S. import of \glsentryshort{ict} services}{fig:US_ICT_Import}{Data source: \url{www.bea.gov/newsreleases/international/trade/trad_time_series.xls}, visited on 10. August 2016}{0.7}
...
\bildcite{US_Offshoring_percentage}{Results of 2012 Survey of Business Owners - U.S. Census Bureau}{fig:USOffshoringPercent}{Data source: \url{http://factfinder.census.gov/faces/tableservices/jsf/pages/productview.xhtml?pid=SBO_2012_00CSCB42&prodType=table}, visited on 19. August 2016}{1}
...
On an international level, \gls{brd} had quickly become a valued trading partner and important exporter of industrial machines, automobiles and chemical products. %CITATION needed
...
\paragraph{Organizational Factors}
Germany's economy is largely influenced by \gls{sme}. Many companies have found their niche where they excel and dominate the market. Often, those companies are family-owned, managed by the owner(s) and rooted in their local community. %Further Facts Mittelstand: Eigentum, Haftung, Leitung, Risiko; IFM Institut für Mittelstandsforschung; Zahlen!!! 99,6% der umsatzsteuerpflichtigen Unternehmen in D
